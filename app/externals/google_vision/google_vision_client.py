        ...
        "requests": [
            {
                ...
                "features": [{"type": "LABEL_DETECTION", "maxResults": 3}, {"type": "LOGO_DETECTION", "maxResults": 1}],
            }
        ]
    }

    async with aiohttp.ClientSession() as session:
        async with session.post(vision_api_url, json=payload, headers={"Content-Type": "application/json"}) as response:
            ...
            return VisionAnalysisResponse(logo_description=logo_description, label_description=label_description)
